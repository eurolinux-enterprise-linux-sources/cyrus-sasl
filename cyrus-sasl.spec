...
# Support non-confidentiality/non-integrity requests from AIX SASL GSSAPI implementation (#1174315)
Patch44: cyrus-sasl-2.1.23-gssapi-non-encrypt.patch
...
%patch44 -p1 -b .gssapi_non_encrypt
...
%changelog
* Fri Feb 27 2015 Jakub Jelen <jjelen@redhat.com> 2.1.23-15.2
...
* Wed Aug 17 2011 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-12
- saslauth now uses fixed uid and gid (#730242)

* Tue Aug 16 2011 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-11
- resolve strict aliasing warnings (#730246)
- repair ntlm support (#720451)

* Mon Aug 15 2011 Jan F. Chadima <jchadima@redhat.com> - 2.1.23-10
